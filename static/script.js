...
async function getState() {
    ...
    state = await submit('GET', `https://buzz-word-project.herokuapp.com/`)
...
function joinGame(room) {
    ...
    submit('POST', `https://buzz-word-project.herokuapp.com/`, roomInfo)
...
async function signUp() {
    ...
    let result = await submit('POST', `https://buzz-word-project.herokuapp.com/`, userinfo)
    console.log(result)
}
...
async function submitWord() {
    let response = await submit('POST', 'https://buzz-word-project.herokuapp.com/', { "letters": letters })
